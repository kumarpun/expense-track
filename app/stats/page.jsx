    ...
    <div className="min-h-screen bg-gray-100 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          {/* Category Breakdown */}
          <div className="bg-white rounded-lg shadow p-4">
            <h2 className="font-semibold text-gray-700 mb-4">Top Categories</h2>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
          ...
          {/* Monthly Trend */}
          <div className="bg-white rounded-lg shadow p-4">
            <h2 className="font-semibold text-gray-700 mb-4">Monthly Trend (Last 6 Months)</h2>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={monthlyTrend} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                  ...
                  <YAxis tick={{ fontSize: 12 }} />
                  <Tooltip formatter={(value) => [`रू ${value.toLocaleString()}`, "Total"]} />
                  <Line
                    type="monotone"
                    dataKey="total"
                    stroke="#3b82f6"
        ...
        {/* Payment Method Breakdown */}
        <div className="bg-white rounded-lg shadow p-4 mb-6">
          <h2 className="font-semibold text-gray-700 mb-4">Payment Method Breakdown</h2>
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={paymentMethodData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                  ...
                  <YAxis tick={{ fontSize: 12 }} />
                  <Tooltip formatter={(value) => [`रू ${value.toLocaleString()}`, "Amount"]} />
            ...
            <div className="space-y-3">
              {paymentMethodData.map((method, index) => (
                <div key={method.name} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className="font-bold text-gray-800">रू {method.value.toLocaleString()}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* Top Expenses Table */}
        <div className="bg-white rounded-lg shadow p-4">
          <h2 className="font-semibold text-gray-700 mb-4">Top 5 Expenses (All Time)</h2>
