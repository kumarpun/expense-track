...
export default function SavingPage() {
    ...
    try {
      if (editingSaving) {
        ...
        if (res.ok) {
          closeModal();
          fetchData();
          addToast("Deposit updated successfully", "success");
        } else {
        ...
        if (res.ok) {
          closeModal();
          fetchData();
          addToast("Deposit added successfully", "success");
        } else {
          addToast("Failed to add deposit", "error");
        }
      }
    } catch (error) {
      console.error("Failed to save:", error);
      addToast("Failed to save deposit", "error");
    } finally {
      setIsSaving(false);
    }
  };
  ...
  const handleDeleteConfirm = async () => {
    try {
      ...
      if (res.ok) {
        fetchData();
        addToast("Deposit deleted successfully", "success");
      } else {
        addToast("Failed to delete deposit", "error");
      }
    } catch (error) {
